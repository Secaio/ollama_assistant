Makesluke Assistant
📌 Sobre o projeto
Makesluke é um modelo para ser usado de base para criar um assistente técnico com memória semântica, desenvolvido para interagir via texto ou voz, armazenar informações relevantes do usuário, editar ou excluir memórias, e responder levando em conta o contexto salvo no banco de dados.
